  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          <div className="glass-panel rounded-2xl p-4 border-blue-500/30 shadow-[0_0_50px_rgba(59,130,246,0.2)] flex items-center gap-4 relative overflow-hidden">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-0.5">
                <h4 className="text-sm font-black text-white uppercase tracking-tight">Price Alert Triggered</h4>
                <div className={cn(
